...
namespace minigin
{
	...
	{
	public:
		HitboxCircleComponent(const std::weak_ptr<Object>& object, const std::string& componentName = "none");
		HitboxCircleComponent(const std::weak_ptr<Object>& object, float size, const std::string& componentName = "none");
		HitboxCircleComponent(const std::weak_ptr<Object>& object, float size, float offsetX, float offsetY, const std::string& componentName = "none");
