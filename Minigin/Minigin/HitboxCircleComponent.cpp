...
HitboxCircleComponent::HitboxCircleComponent(const std::shared_ptr<Object>& object)
	:HitboxCircleComponent(object, 0.f, 0.f, 0.f)
{
}

HitboxCircleComponent::HitboxCircleComponent(const std::shared_ptr<Object>& object, float size)
	:HitboxCircleComponent(object, size, 0.f, 0.f)
{
}

HitboxCircleComponent::HitboxCircleComponent(const std::shared_ptr<Object>& object, float size, float offsetX, float offsetY)
